...
public class ChecForm extends JFrame {
    ...
    public ChecForm(int userId) {
        ...
        // Dodajemy ID_wypozyczenia do modelu tabeli, ale nie do widocznych kolumn
        String[] columnNames = {"ID Wypożyczenia", "Id książki", "Tytuł książki", "Autor", "Termin zwrotu"};
        ...
        wsteczButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                dispose();
                MainSystem main = new MainSystem(loggedInUserId); // Przekazanie ID użytkownika do MainSystem
    ...
    private void populateBorrowedBooksTable(int userId) {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            String query = "SELECT wyporzyczenia.ID_wyp AS id_wypozyczenia, ksiazki.book_ID AS id_ksiazki, " +
                    ...
                    "wyporzyczenia.data_zwrotu AS data_zwrotu " +
                    "FROM wyporzyczenia " +
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                ...
                try (ResultSet resultSet = statement.executeQuery()) {
                    while (resultSet.next()) {
                        ...
                        Object[] row = {borrowId, bookId, bookName, bookAuthor, returnDate};
